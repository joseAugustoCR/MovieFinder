...
class WelcomeFragment : BaseFragment() {
    ...
    fun setLayout(){
        msg.text = Html.fromHtml(getString(R.string.welcome_msg))
    }

    fun setListeners(){
        startBtn.setOnClickListener {
            sharedPreferencesManager.putObject(WELCOME, true)
            safeNavigate(navController, WelcomeFragmentDirections.actionWelcomeFragmentToMainFragment())
        }
    }
